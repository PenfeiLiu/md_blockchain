...
<title>中国网络安全审查与认证区块链平台-现场审核资料上传</title>
      ...
      <li class=" nav-item"><a href="#"><i class="la la-navicon"></i><span class="menu-title" data-i18n="nav.navbars.main">数据上传
        ...
        <ul class="menu-content">
          ...
          <ul class="menu-content">
              ...
              <li class="active"><a class="menu-item" href="upload_Site_audit.jsp" data-i18n="">现场审核资料上传</a> </li>
        ...
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb" style="font-family:microsoft yahei;">
              ...
              <li class="breadcrumb-item">现场审核资料上传</li>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="horz-layout-icons" style="margin:20px 0 0 20px; font-family:microsoft yahei;">现场审核资料上传</h4>
                ...
                <div class="card-content collpase show" style="padding-bottom:4rem;">
                  <div class="card-body">
                    ...
                    <form:form class="form form-horizontal" action="/uploadOnSiteAuditData" method="post" modelAttribute="onSiteAuditData">
                      <div class="form-body">
                        ...
                        <div class="form-group row">
                          <label class="col-md-3 label-control">现场审核报告结论</label>
                          <div class="col-md-9">
                            <div class="position-relative has-icon-left">
                              <form:input type="text" id="conclusion" class="form-control" placeholder="现场审核报告结论"
                              name="现场审核报告结论" path="onSiteCheckResult"/>
                              <div class="form-control-position">
                                <i class="ft-award"></i>
                              </div>
                            </div>
                         ...
                         <div class="form-group row">
                          ...
                          <div class="col-md-9">
                            <div class="position-relative has-icon-left">
                               <form:input type="text" id="审核时间" class="form-control dp-for-alternate"  path="checkTime"/>
                              <div class="form-control-position">
                                <i class="ft-clock"></i>
                              </div>
                            </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-actions right"> <input type="submit" value="保存" class="btn btn-primary mr-1" style="margin:0 0 0 214px;padding-left:40px; padding-right:40px;">
