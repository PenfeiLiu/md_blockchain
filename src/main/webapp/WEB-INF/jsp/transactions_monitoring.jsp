...
<head>
  ...
  <title>中国网络安全审查与认证区块链平台-交易信息实时监控
  </title>
...
<li class="nav-item open"><a href="Request_list.jsp"><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">用户审核
      ...
      <li class="nav-item"><a href="#"><i class="la la-header"></i><span class="menu-title" data-i18n="nav.page_headers.main">平台监控</span></a>
        <ul class="menu-content">
          <li><a class="menu-item" href="Integrated_monitoring.jsp" data-i18n="">综合监控</a> </li>
          ...
          <li class="active"><a class="menu-item" href="transactions_monitoring.jsp" data-i18n="">交易信息实时监控</a> </li>        
      ...
      <div class="row breadcrumbs-top">
        <div class="breadcrumb-wrapper col-12">
          <ol class="breadcrumb" style="font-family:microsoft yahei;">
            ...
            <li class="breadcrumb-item"><a href="index.jsp">平台监控</a> </li>
            <li class="breadcrumb-item">交易信息实时监控</li>
          </ol>
        </div>
      </div>
    </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title" style="margin:20px 0 0 20px; font-family:microsoft yahei;">交易信息实时监控列表</h4>
                    ...
                    <div class="jsgrid-grid-header jsgrid-header-scrollbar">
                      <table class="jsgrid-table">
                        <tr class="jsgrid-header-row">
                          <th class="jsgrid-header-cell jsgrid-align-center" style="width: 50px;">Creator</th>
                          <th class="jsgrid-header-cell jsgrid-align-center" style="width: 90px;">Tx id</th>
                          <th class="jsgrid-header-cell jsgrid-align-center" style="width: 105px;">Type</th>
                          <th class="jsgrid-header-cell jsgrid-align-center" style="width: 105px;">Chaincode</th>
                          <th class="jsgrid-header-cell jsgrid-align-center" style="width: 200px;">Timestamp</th>
                        </tr>
