...
<title>中国网络安全审查与认证区块链平台-试运行数据上传</title>
        ...
        <ul class="menu-content">
         ...
         <li><a class="menu-item" href="" data-i18n="">检测检验数据上传</a>
          <ul class="menu-content">
              ...
              <li class="active"><a class="menu-item" href="upload_test_run.jsp" data-i18n="">试运行数据上传</a> </li>
        ...
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb" style="font-family:microsoft yahei;">
              ...
              <li class="breadcrumb-item">试运行数据上传</li>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title" id="horz-layout-icons" style="margin:20px 0 0 20px; font-family:microsoft yahei;">试运行数据上传</h4>
                    ...
                    <form class="form form-horizontal">
                      <div class="form-body">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                          <label class="col-md-3 label-control">试运行时间</label>
                          <div class="col-md-9">
                            <div class="position-relative has-icon-left">
                               <input type="text" id="testRunTime" class="form-control dp-for-alternate"  placeholder="试运行时间"
                              name="试运行时间"/>
                              <div class="form-control-position">
                                <i class="ft-clock"></i>
                              </div>
