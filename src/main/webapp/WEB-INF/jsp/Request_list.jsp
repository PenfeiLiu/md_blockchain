...
<title>中国网络安全审查与认证区块链平台-用户注册申请列表</title>
        ...
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-12">
            <ol class="breadcrumb" style="font-family:microsoft yahei;">
              ...
              <li class="breadcrumb-item active">用户注册申请列表 </li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title" style="margin:20px 0 0 20px; font-family:microsoft yahei;">用户注册申请列表</h4>
                  ...
                  <div id="" class="js-shorting jsgrid" style="position: relative; height: 400px; width: 100%;">
                      ...
                      <table class="jsgrid-table">
                        <tbody>
                          <tr class="jsgrid-row">
                            ...
                            <td class="jsgrid-cell jsgrid-align-center" style="width: 200px;"><a href="Request_details.jsp"> <a href="Request_details.jsp"> <span class="badge badge-primary" style="padding:8px 8px;">查看详情</span></a></a>
                   &nbsp;&nbsp; <span class="badge badge-success"  style="padding:8px 8px;">审核通过</span></td>
                           ...
                           <tr class="jsgrid-alt-row">
                            ...
                            <td class="jsgrid-cell jsgrid-align-center" style="width: 100px;">张恩丽</td>
                            <td class="jsgrid-cell jsgrid-align-center" style="width: 100px;">2019-03-05</td>
                            <td class="jsgrid-cell jsgrid-align-center" style="width: 200px;"> <a href="Request_details.jsp"> <span class="badge badge-primary" style="padding:8px 8px;">查看详情</span></a>
                   &nbsp;&nbsp; <span class="badge badge-success"  style="padding:8px 8px;">审核通过</span></td>
                          </tr>
                         <tr class="jsgrid-row">
